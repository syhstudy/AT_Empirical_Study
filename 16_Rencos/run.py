...
def main(opt, mode=2):
    if opt == 'preprocess':
        command = "python preprocess.py -train_src samples/%s/train/train.code.src \
                        -train_tgt samples/%s/train/train.nl.tgt \
                        -valid_src samples/%s/valid/valid.code.src \
                        -valid_tgt samples/%s/valid/valid.nl.tgt \
